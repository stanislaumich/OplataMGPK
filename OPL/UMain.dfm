object Form1: TForm1
  Left = 0
  Top = 0
  Caption = #1059#1095#1077#1090' '#1086#1087#1083#1072#1090#1099' '#1086#1073#1091#1095#1077#1085#1080#1103' '#1091#1095#1072#1097#1080#1084#1080#1089#1103' '#1052#1043#1055#1050
  ClientHeight = 742
  ClientWidth = 937
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object GroupBox1: TGroupBox
        ...
        object ComboBox1: TComboBox
          ...
          Height = 21
          TabOrder = 0
          Text = #1047#1040#1054#1063#1053#1054#1045' '#1054#1058#1044#1045#1051#1045#1053#1048#1045
          Items.Strings = (
            #1047#1040#1054#1063#1053#1054#1045' '#1054#1058#1044#1045#1051#1045#1053#1048#1045
            #1044#1053#1045#1042#1053#1054#1045' '#1054#1058#1044#1045#1051#1045#1053#1048#1045
            #1042#1057#1045' '#1054#1058#1044#1045#1051#1045#1053#1048#1071)
        end
    ...
    object TabSheet4: TTabSheet
      ...
      object GroupBox3: TGroupBox
        ...
        Height = 654
        Align = alLeft
        Caption = #1047#1072#1075#1088#1091#1079#1082#1072' '#1092#1072#1081#1083#1086#1074' '#1073#1072#1085#1082#1072
        TabOrder = 0
    ...
    object TabSheet5: TTabSheet
      Caption = #1043#1088#1091#1087#1087#1099' '#1080' '#1091#1095#1072#1097#1080#1077#1089#1103
      ImageIndex = 4
    end
  end
